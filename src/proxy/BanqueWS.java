 ...
 * 
 */
@WebServiceClient(name = "BanqueWS", targetNamespace = "http://services/", wsdlLocation = "http://localhost:8086/BanqueService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName BANQUEWS_QNAME = new QName("http://services/", "BanqueWS");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8086/BanqueService?wsdl");
    ...
    public BanqueService getBanqueServicePort() {
        return super.getPort(new QName("http://services/", "BanqueServicePort"), BanqueService.class);
    }
    ...
    public BanqueService getBanqueServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://services/", "BanqueServicePort"), BanqueService.class, features);
    }
